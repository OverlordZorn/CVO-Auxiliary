class CfgPlaylists
{
    ...
    class GVAR(Desiderii_Marginis)
    {
        name = "Desiderii Marginis";
        dependencies[] = {"cvo_ogg_music"};
        tracks[] = {
    ...
    class GVAR(Saharan_Cellphone_Music)
    {
        name = "Saharan Cellphone Music";
        dependencies[] = {"cvo_ogg_music"};
        tracks[] = {
